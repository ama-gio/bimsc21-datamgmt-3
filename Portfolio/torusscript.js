...
amplitude_slider.addEventListener("mouseup", onSliderChange, false);
amplitude_slider.addEventListener("touchend", onSliderChange, false);
...
async function compute() {
  ...
  const param3 = new RhinoCompute.Grasshopper.DataTree("Amplitude");
  param3.append([0], [amplitude_slider.valueAsNumber]);
